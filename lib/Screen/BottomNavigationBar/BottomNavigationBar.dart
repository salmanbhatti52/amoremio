...
//                  label: "", icon: currentIndex == 0 ?  SvgPicture.asset(ImageAssets.explore2) : SvgPicture.asset(ImageAssets.explore1),),
//                 BottomNavigationBarItem(
//                   label: "",  icon: currentIndex == 1 ?  SvgPicture.asset(ImageAssets.storyView2) : SvgPicture.asset(ImageAssets.storyView1),),
//                 BottomNavigationBarItem(
//                     label: "",  icon: currentIndex == 2 ?  SvgPicture.asset(ImageAssets.createStory1, color: AppColor.secondaryColor,) : SvgPicture.asset(ImageAssets.createStory1)),
//                 BottomNavigationBarItem(
//                     label: "",  icon: currentIndex == 3 ?  SvgPicture.asset(ImageAssets.chat2) : SvgPicture.asset(ImageAssets.chat1)),
//                 BottomNavigationBarItem(
//                     label: "",  icon: currentIndex == 4 ?  SvgPicture.asset(ImageAssets.profile2) : SvgPicture.asset(ImageAssets.profile1)),
//               ],
//           ),
//         ),
//       ),
  ...
  List<PersistentBottomNavBarItem> _navBarsItems() {
    return [
      ...
      PersistentBottomNavBarItem(
        ...
        inactiveIcon:  SvgPicture.asset(ImageAssets.chat2, color: AppColor.hintTextColor,),
