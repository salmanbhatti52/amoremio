...
class ChatDetailsPage extends StatefulWidget {
  final String? monetizeCheck;
  final String userId;
  const ChatDetailsPage({Key? key, this.monetizeCheck, required this.userId})
      : super(key: key);
...
class _ChatDetailsPageState extends State<ChatDetailsPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance!.addPostFrameCallback((_) {
      widget.monetizeCheck == "Yes" ? monetizeDialog() : null;
    });
  }
