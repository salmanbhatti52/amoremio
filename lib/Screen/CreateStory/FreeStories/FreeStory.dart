...
class FreeStory extends StatefulWidget {
  final double height;
  ...
  @override
  State<FreeStory> createState() => _FreeStoryState();
}

class _FreeStoryState extends State<FreeStory> {
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              borderRadius: const BorderRadius.only(
                                bottomRight: Radius.circular(3.40),
                                bottomLeft: Radius.circular(3.40),
                              ),
