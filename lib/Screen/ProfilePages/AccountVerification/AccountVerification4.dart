...
import 'AccountVerification5.dart';
...
class AccountVerification4 extends StatefulWidget {
  final String imgUrl2;
  final String imgUrl;
  const AccountVerification4({Key? key, required this.imgUrl2, required this.imgUrl,}) : super(key: key);

  @override
  State<AccountVerification4> createState() => _AccountVerification4State();
}

class _AccountVerification4State extends State<AccountVerification4> {
  @override
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              const MyText(
                text: "Upload Your Selfie Pose Image\nfor verification",
                fontWeight: FontWeight.w500,
                fontSize: 18,
              ),
              SizedBox(
              ...
              LargeButton(
                ...
                onTap: () {
                  if (base64Image != null && base64Image!.isNotEmpty) {
                    Get.to(
                          () => AccountVerification5(imgUrl: widget.imgUrl, imgUrl2: widget.imgUrl2, imgUrl3: base64Image.toString(),),
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text("Please Upload Your Selfie Pose Image"),
                      ),
                    );
                  }
                },
